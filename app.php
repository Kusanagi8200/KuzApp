...
<head>
    ...
    <style>
        ...
        .background-container {
            position: fixed; /* Reste fixe au fond */
            top: 5px; /* Espacement de 5px du haut */
            left: 5px; /* Espacement de 5px à gauche */
            right: 5px; /* Espacement de 5px à droite */
            bottom: 5px; /* Espacement de 5px du bas */
            background-image: url('https://192.168.124.187:8443/KuzApp/KuzApp-Fond.jpg'); 
            background-size: cover; /* L'image couvre toute la page */
            background-position: center; /* L'image est centrée */
            background-attachment: fixed; /* L'image reste fixe lors du défilement */
            border-radius: 20px; /* Applique des coins arrondis */
            z-index: -1; /* Place l'élément derrière le contenu principal */
        }
...
<body>
    ...
    <div class="background-container"></div> <!-- Conteneur avec fond d'image -->
