...
# 1. System update
log_message " --> IN PROGRESS.... UPDATING THE SYSTEM..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... CLEANING UP THE SYSTEM AFTER INSTALLATIONS..." "[INFO]" "\033[48;5;33m"
sudo apt clean
sudo apt autoclean
...
log_message " --> IN PROGRESS.... ENABLING APACHE MODULES..." "[INFO]" "\033[48;5;33m"
sudo a2enmod ssl || true
sudo a2enmod rewrite || true
echo # 

# Clone KuzApp repository
log_message " --> IN PROGRESS.... CLONING KUZAPP REPOSITORY..." "[INFO]" "\033[48;5;33m"
...
log_message "--> IN PROGRESS.... SETTING UP MYSQL DATABASE..." "[INFO]" "\033[48;5;33m"
sudo mysql -u root -e "
...
log_message " --> IN PROGRESS.... CONFIGURING APACHE VIRTUAL HOST..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... ENSURING APACHE LISTENS ON PORT 443..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... SETTING FILE PERMISSIONS..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... CONFIGURING DATABASE CONNECTION (CONFIG.PHP)..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... VERIFYING THE BACKGROUND IMAGE..." "[INFO]" "\033[48;5;33m"
...
log_message " --> IN PROGRESS.... RESTARTING APACHE2 SERVICE..." "[INFO]" "\033[48;5;33m"
...
echo -e "\033[48;5;208m\033[30;1mOK...NOW YOU CAN TEST KUZAPP ON LIVE --> \033[0m https://$IP/login.php"
echo
